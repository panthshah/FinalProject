 ...
 * @generated
 */
public class FinalProjectSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FinalProjectPackage.COUPON: {
				Coupon coupon = (Coupon)theEObject;
				T result = caseCoupon(coupon);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case FinalProjectPackage.POOLER: {
				Pooler pooler = (Pooler)theEObject;
				T result = casePooler(pooler);
				if (result == null) result = caseUser(pooler);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Coupon</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Coupon</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCoupon(Coupon object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Pooler</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Pooler</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePooler(Pooler object) {
		return null;
	}
